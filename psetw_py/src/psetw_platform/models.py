...
class Activity(Base):
    ...
    sub_activity: Mapped[str] = mapped_column(String(300), default="")
    ...
    planned_duration_hours: Mapped[int] = mapped_column(Integer, default=0)
    actual_start_date: Mapped[date | None] = mapped_column(Date, nullable=True)
    actual_end_date: Mapped[date | None] = mapped_column(Date, nullable=True)
    actual_duration_hours: Mapped[int] = mapped_column(Integer, default=0)
    base_effort_hours: Mapped[int] = mapped_column(Integer, default=0)
    required_materials: Mapped[str] = mapped_column(Text, default="")
    required_tools: Mapped[str] = mapped_column(Text, default="")
    dependencies: Mapped[list[str]] = mapped_column(JSON, default=list)
    dependency_type: Mapped[str] = mapped_column(String(12), default="FS")
    priority: Mapped[str] = mapped_column(String(32), default="Medium")
    milestone: Mapped[str] = mapped_column(String(200), default="")
    assigned_manpower: Mapped[int] = mapped_column(Integer, default=1)
    manpower_skill_level: Mapped[str] = mapped_column(String(120), default="")
    resource_name: Mapped[str] = mapped_column(String(200), default="")
    resource_department: Mapped[str] = mapped_column(String(200), default="")
    shift_type: Mapped[str] = mapped_column(String(80), default="")
    ...
    material_supplier: Mapped[str] = mapped_column(String(200), default="")
    material_criticality: Mapped[str] = mapped_column(String(64), default="Medium")
    material_required_date: Mapped[date | None] = mapped_column(Date, nullable=True)
    material_received_date: Mapped[date | None] = mapped_column(Date, nullable=True)
    material_lead_time: Mapped[int] = mapped_column(Integer, default=0)
    risk_level: Mapped[str] = mapped_column(String(32), default="Low")
    risk_score: Mapped[int] = mapped_column(Integer, default=0)
    risk_probability: Mapped[int] = mapped_column(Integer, default=3)
    risk_impact: Mapped[int] = mapped_column(Integer, default=3)
    risk_mitigation_status: Mapped[str] = mapped_column(String(64), default="Planned")
    risk_owner: Mapped[str] = mapped_column(String(200), default="")
    risk_review_date: Mapped[date | None] = mapped_column(Date, nullable=True)
    manual_override_duration: Mapped[int] = mapped_column(Integer, default=0)
    override_reason: Mapped[str] = mapped_column(Text, default="")
    override_approved_by: Mapped[str] = mapped_column(String(200), default="")
    ...
    last_modified_by: Mapped[str] = mapped_column(String(120), default="")
